  ...
  const projectsData = [
    {
      ...
      icon: Cpu,
      accentColor: "from-iot-cyan to-blue-500",
      accentBorder: "group-hover:border-iot-cyan/40",
      glowBg: "rgba(0, 242, 254, 0.05)",
      previewIcon: Cpu,
      demoLink: "#",
      githubLink: "#",
    ...
    },
    {
      ...
      icon: ShieldCheck,
      accentColor: "from-cyber-green to-emerald-500",
      accentBorder: "group-hover:border-cyber-green/40",
      glowBg: "rgba(57, 255, 20, 0.05)",
    ...
    },
    {
      ...
      icon: Droplet,
      accentColor: "from-block-purple to-pink-500",
      accentBorder: "group-hover:border-block-purple/40",
      glowBg: "rgba(138, 43, 226, 0.05)",
      previewIcon: Droplet,
      demoLink: "#",
      githubLink: "#",
